...
//   const [
//     updateApplication,
//     { isLoading: isUpdating, isError: updateError, error: updateErr },
//   ] = useUpdateApplicationMutation();
...
//     }
//     console.log("API response:", existingApplication);
//   }, [existingApplication]);
...
//   if (isError) {
//     return (
//       <ErrorPage message={error?.toString() || "Failed to load application"} />
//     );
//   }
